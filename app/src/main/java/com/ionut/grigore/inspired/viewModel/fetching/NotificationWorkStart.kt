    ...
    companion object{
        ...
        fun notifEmptyDB(context: Context): Notification{
            ...
            return  NotificationCompat.Builder(context, NOTIFICATION_CHANNEL_ID)
                ...
                .setContentText(context.getString(R.string.no_fetched_quotes))
                .setStyle(NotificationCompat.BigTextStyle().bigText(context.getString(R.string.no_fetched_quotes)))
                .setContentIntent(pendingIntentOpenApp)
                .setAutoCancel(true)
                .build()
        }
